...
class SeaBreezeFeature:
    ...
    @classmethod
    def specialize(cls: Type[SeaBreezeFeature], model_name: str, **kwargs: str) -> Type[FT]: ...
...
class SeaBreezeGPIOFeature(SeaBreezeFeature):
    ...
    def set_gpio_output_enable_vector(self, output_enable_vector: int, bit_mask: int) -> None: ...
...
class SeaBreezeI2CMasterFeature(SeaBreezeFeature):
    ...
    def read_bus(self, bus_index: int, slave_address: int, buffer_length: int = 1024) -> bytes: ...
...
class SeaBreezeIPv4Feature(SeaBreezeFeature):
    ...
    def set_default_gateway(self, interface_index: int, default_gateway_address: str) -> None: ...
...
class SeaBreezeMulticastFeature(SeaBreezeFeature):
    ...
    def set_multicast_enable_state(self, interface_index: int, enable_state: bool) -> None: ...
...
class SeaBreezeNetworkConfigurationFeature(SeaBreezeFeature):
    ...
    def set_network_interface_enable_state(self, interface_index: int, enable_state: bool) -> None: ...
...
class SeaBreezeRawUSBBusAccessFeature(SeaBreezeFeature):
    def raw_usb_write(self, data: bytes, endpoint: Literal["primary_out", "secondary_out"]) -> None: ...
    def raw_usb_read(self, endpoint: Literal["primary_in", "secondary_in", "secondary_in2"], buffer_length: Optional[int] = None) -> bytes: ...
